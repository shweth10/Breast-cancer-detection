    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <div class="card mb-4">
          ...
          <p class="mb-4"><span class="text-primary  me-1">Personal</span> Details
                </p>
            <div class="row">
              <div class="col-sm-3">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{ $client->client_fname }}</p>
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              <div class="col-sm-3">
                <p class="mb-0">Driving Registration Number</p>
              </div>
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{ $client->driving_license_number }}</p>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-3">
                <p class="mb-0">vehicle_registration</p>
              </div>
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{ $client->vehicle_registration }}</p>
              </div>
            </div>
